# Hydroline Beacon Provider 源码结构与开发要点
...
- loader 项目通过 shadowJar 将 Architectury API Relocate 到 `com.hydroline.beacon.shaded.architectury`，避免与 MTR 或其他 mod 冲突；JAR 名称统一为 `archivesBaseName-loader-minecraftVersion`。
